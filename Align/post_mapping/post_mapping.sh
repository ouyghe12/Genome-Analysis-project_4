...
#SBATCH -n 10
#SBATCH -t 20:00:00
#SBATCH -J post_mapping
#SBATCH --mail-type=ALL
#SBATCH --mail-user wenjie.ouyang.9030@student.uu.se
#SBATCH --output=post_mapping_pilon1.%j.out
#SBATCH --error=post_mapping_pilon1.%j.err
...
mkdir -p VCF
cd VCF
export SRCDIR=/home/ouyghe/genome_analysis/Genome-Analysis-project_4/Align/post_mapping
ln -s /home/ouyghe/genome_analysis/Genome-Analysis-project_4/DNA_assembly/pilon/pilon.fasta .
...
bowtie2-build pilon.fasta genome
